...
<div class="frm_sidebar_login_wrapper">
	<form action="http://savingstore.com.hk/index.php?route=account/login" method="post" enctype="multipart/form-data" class="frm_sidebar_login">
		<div class="login-con">
		    ...
		    <a href="http://savingstore.com.hk/index.php?route=account/forgotten">
		    	<button class="half-btn-left btn_not_submit forgot_pwd">忘記密碼</button>
		    </a>
		    <button class="half-btn-right" type="submit">登入</button>
		    <a href="http://savingstore.com.hk/index.php?route=account/register">
...
<?php else: ?>
	...
	<div class="login-con" class="frm_sidebar_login">
		...
		<a href="http://savingstore.com.hk/index.php?route=account/account">
	    	<button class="half-btn-left">編輯資料</button>
	    </a>
	    <a href="http://savingstore.com.hk/index.php?route=account/logout">

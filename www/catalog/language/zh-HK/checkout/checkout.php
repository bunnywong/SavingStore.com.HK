...
$_['text_checkout_payment_method']   = '第 5 步: 付款方式';
...
$_['text_agree']                     = '我已經閱讀並同意條款 <a class="fancybox" href="%s" alt="%s"><b>%s</b></a>';
$_['text_address_new']               = '註冊一個新地址';
...
// Error
$_['error_warning']                  = '在結算時出現了問題! 如果此問題繼續存在請使用其它付款方式或<a href="%s">聯繫我們</a>.';
...
$_['error_no_shipping']              = '無可以貨運方式. 請<a href="%s">聯繫我們</a> 以獲取幫助!';
